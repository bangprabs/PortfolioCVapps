...
public class CustomListAdapterEx extends ArrayAdapter<String> {
    ...
    public CustomListAdapterEx(Activity context, String[] menuItem, String[] menuDesk, Integer[] menuImage) {
