...
public class CustomListAdapterOrg extends ArrayAdapter<String> {
    ...
    public CustomListAdapterOrg(Activity context, String[] menuItem, String[] menuDesk, Integer[] menuImage) {
        super(context, R.layout.activity_list_org, menuItem);
    ...
    public View getView(int position, View view, ViewGroup parent){
        ...
        View rowView = inflater.inflate(R.layout.activity_list_org, null, true);
