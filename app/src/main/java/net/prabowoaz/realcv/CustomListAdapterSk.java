...
public class CustomListAdapterSk extends ArrayAdapter<String> {
    ...
    public CustomListAdapterSk(Activity context, String[] menuItem, String[] menuDesk, Integer[] menuImage) {
        super(context, R.layout.activity_list_skills, menuItem);
    ...
    public View getView(int position, View view, ViewGroup parent){
        ...
        View rowView = inflater.inflate(R.layout.activity_list_skills, null, true);
